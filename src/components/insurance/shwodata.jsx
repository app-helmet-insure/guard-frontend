...
import DataIcon1 from '@/images/insurance/data_icon_1.svg';
import DataIcon2 from '@/images/insurance/data_icon_2.svg';
import DataIcon3 from '@/images/insurance/data_icon_3.svg';

class shwodata extends Component {
    render() {
        return (
